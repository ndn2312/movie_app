...
<script>
    $(document).ready(function() {
        ...
        $(document).on('submit', '.delete-form', function(e) {
            ...
            if (confirm('Bạn có chắc muốn xóa thể loại này?')) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        hideLoading();
                        showToast('error', 'Có lỗi xảy ra khi xóa thể loại!');
                    }
                });
            }
        });
        ...
        function updateUI(response, searchTerm) {
            // Cập nhật grid thể loại
            $('#genreGrid').html(response.html);
            ...
            if (response.total === 0) {
                ...
                $('.genre-card').each(function(index) {
