    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <h2 class="section-title"><i class="fa-solid fa-film"></i>Quản lý danh mục phim</h2>
                <br>
                @if($errors->any())
                ...
                <div class="card-body">
                    ...
                    @else
                    {!! Form::open(['route' => ['movie.update', $movie->id],
                    'method'=>'PUT','enctype'=>'multipart/form-data']) !!}

                    @endif
                    <div class="form-group">
                        {!! Form::label('title','Tên phim',['class' => 'd-block mb-2']) !!}
                        {!! Form::text('title',isset($movie)? $movie->title:'',
                        ['class'=>'form-control','placeholder'=>'Nhập vào dữ
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('director','Đạo diễn',['class' => 'd-block mb-2']) !!}
                        {!! Form::text('director',isset($movie)? $movie->director:'',
                        ['class'=>'form-control','placeholder'=>'Nhập tên đạo diễn...']) !!}
                    </div>
                    <br>
                    <div class="form-group">
                        {!! Form::label('actors','Diễn viên',['class' => 'd-block mb-2']) !!}
                        {!! Form::text('actors',isset($movie)? $movie->actors:'',
                        ['class'=>'form-control','placeholder'=>'Nhập tên diễn viên, cách nhau bằng dấu phẩy...']) !!}
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        ['class'=>'form-control','placeholder'=>'Nhập vào dữ liệu...','id'=>'convert_slug']) !!}
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        '5'=>'Trailer'], isset($movie) ? $movie->resolution : '', ['class'=>'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('thuocphim', ['phimle'=>'Phim lẻ','phimbo'=>'Phim bộ'],isset($movie) ?
                        $movie->thuocphim : '', ['class'=>'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ $movie->image }}"
                            style="width: 150px; height: auto; object-fit: cover; display: block; margin-top: 10px;">
                        @else
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('poster_url', 'Poster URL', ['class' => 'd-block mb-2']) !!}
                        {!! Form::text('poster_url', isset($movie) ? $movie->poster_url : '', ['class' =>
                        'form-control', 'placeholder' => 'Nhập URL poster...']) !!}
                    </div>

                    <br>
                    <div class="form-group">
                        {!! Form::label('thumb_url', 'Thumbnail URL', ['class' => 'd-block mb-2']) !!}
                        {!! Form::text('thumb_url', isset($movie) ? $movie->thumb_url : '', ['class' => 'form-control',
