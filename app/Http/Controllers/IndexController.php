...
class IndexController extends Controller
{
    ...
    public function year($year){
        ...
        $year = $year;
        $movie = Movie::where('year',$year)->orderBy('ngaycapnhat','DESC')->paginate(4);
    ...
    public function tag($tag){
        ...
        $tag = $tag;
        $movie = Movie::where('tags','LIKE','%'.$tag.'%')->orderBy('ngaycapnhat','DESC')->paginate(4);
    ...
    public function country($slug){
        ...
        $movie = Movie::where('country_id',$country_slug->id)->orderBy('ngaycapnhat','DESC')->paginate(4);
